        ...
        },
        {
            ...
            items : [
                ...
                },
                {
                 ...
                 {
                    xtype: 'button',
                    itemId: 'cadSendQuery2So',
                    reference: 'cadSendQuery2So',
                    text: 'Query To SO',
                    hidden: true,
                    listeners: {
                        click: 'onClickCadSendQuery2So'
                    }
                },
                {
                    xtype: 'button',
                    itemId: 'cadSendQuery2Ca',
                    reference: 'cadSendQuery2Ca',
                    text: 'Query To CA',
                    hidden: true,
                    listeners: {
                        click: 'onClickCadSendQuery2Ca'
                    }
                },
