...
public class User {
	...
	private Integer roleToStateMapVer;
	...
	public Integer getRoleToStateMapVer() {
		return roleToStateMapVer;
	}

	public void setRoleToStateMapVer(Integer roleToStateMapVer) {
		this.roleToStateMapVer = roleToStateMapVer;
	}
	...
	public static final Map<String, String> getRs2BeanMap() {
		...
		if (rs2BeanMap == null) {
			...
			rs2BeanMap.put("id_customer_user_key", "custUserId");
			rs2BeanMap.put("id_fsm_state_key", "stateId");
			rs2BeanMap.put("id_role_key", "roleId");
			
			rs2BeanMap.put("id_role_state_map_ver", "roleToStateMapVer");
