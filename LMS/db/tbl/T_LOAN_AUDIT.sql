...
--ALTER TABLE T_LOAN_AUDIT ADD tx_sourcing_brc VARCHAR(256) NULL 
...
-- ALTER TABLE T_LOAN ADD tx_mobile_guarantor VARCHAR (256)  NULL;
-- ALTER TABLE T_LOAN_AUDIT ADD tx_mobile_guarantor VARCHAR (256)  NULL;